...
<body>
    <div class="container">
        ...
        <div class="room-list">
            ...
            <form method="get" action="view_rooms.php" class="filter-form">
            ...
            <!-- Sorting Links -->
            <p>Sort by:
                <a href="view_rooms.php?sort=room_number&order=asc&search=<?= urlencode($search) ?>&room_type=<?= urlencode($room_type) ?>">Room Number Asc</a> |
                <a href="view_rooms.php?sort=room_number&order=desc&search=<?= urlencode($search) ?>&room_type=<?= urlencode($room_type) ?>">Room Number Desc</a> |
                <a href="view_rooms.php?sort=price&order=asc&search=<?= urlencode($search) ?>&room_type=<?= urlencode($room_type) ?>">Price Asc</a> |
                <a href="view_rooms.php?sort=price&order=desc&search=<?= urlencode($search) ?>&room_type=<?= urlencode($room_type) ?>">Price Desc</a>
            </p>
