...
<html lang="en">
<head>
    <title>Hotelia - Admin Dashboard</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row site-hero-inner justify-content-center align-items-center">
                <div class="col-md-10 text-center">
                    <h1 class="heading" data-aos="fade-up">Admin Dashboard</h1>
                    <p class="sub-heading mb-5" data-aos="fade-up" data-aos-delay="100">Manage the hotel efficiently.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <ul class="list-unstyled text-center">
                <li><a href="user_index.php" class="btn btn-primary">Manage Users</a></li>
                <li><a href="booking_index.php" class="btn btn-primary">Manage Bookings</a></li>
                <li><a href="room_index.php" class="btn btn-primary">Manage Rooms</a></li>
            </ul>
        </div>
    </section>
